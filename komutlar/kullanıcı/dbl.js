...
dbl.hasVoted(message.author.id).then(voted => {
  ...
  if (!botcuk) return message.channel.send("<:neutralno:910935142707646484> Lütfen bir bot adı giriniz.");
  if (!dbl.getBot(botcuk.id)) return message.channel.send("<:neutralno:910935142707646484> Böyle bir bot yok.");
