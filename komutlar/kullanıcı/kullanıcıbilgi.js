...
var durum = ''
  ...
  var durum = 'Aktif'
   ...
   • | Hesap Kurulum Tarihi: **<t:${parseInt(kişi.createdAt / 1000)}> (<t:${parseInt(kişi.createdAt / 1000)}:R>)**
   `, true)
   ...
   .replace("EARLY_VERIFIED_DEVELOPER", "• | **Erken Doğrulanmış Bot Geliştiricisi**")
   ...
   .replace("VERIFIED_BOT", "• | **Doğrulanmış Bot**") : `**Yok**`, true)
