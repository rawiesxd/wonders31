...
exports.run = async(client, message, args, prefix) => {
    try {
        ...
        if(!args[0]) {
            ...
            .setDescription(`
            <:wunlem:911958090298032228> Yedekleme Sistemi Komutları Aşağıda Gözükecektir.
        ...
        if(args[0] === "oluştur" || args[0] === "al" || args[0] === "create") {
          ...
          .setTitle(`<:wunlem:911958090298032228> Lütfen Bekleyiniz...`)
          .setDescription("<:wunlem:911958090298032228> Yedek Oluşturuluyor...")
          .setColor(client.ayarlar.embedRenk)
          .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({ dynamic: true }))
        message.channel.send(creatingEmbed).then(sa => {
            ...
            const roles = message.guild.roles.cache.filter(r => r.name !== "@everyone").sort(function(a, b) {
              ...
              .setAuthor(`${client.ayarlar.botİsim} Bot`, message.author.avatarURL({ dynamic: true }))
              .setDescription(`<:neutralyes:910935020120735806> Sayın ${message.author}, Başarılı bir şekilde bu sunucu için yedek alındı!`)
        ...
        if(args[0] === "list" || args[0] === "liste") {
            ...
            if(!db.has(`yedek_${message.author.id}`) === true) {
                var yok = new Discord.MessageEmbed()
                    .setAuthor(`${client.ayarlar.botİsim} Bot`, message.author.avatarURL({dynamic:true}))
                    .setColor(client.ayarlar.embedRenk)
                    .setDescription(`<:neutralno:910935142707646484> Sayın ${message.author}, Üzgünüm ancak yedek listeni gösteremicem! Sebep: \`Hiç Bir Yedek Kodun Yok!\``)
                    .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({dynamic:true}))
        ...
        if(args[0] === "clear" || args[0] === "temizle") {
            ...
            if(!db.has(`yedek_${message.author.id}`) === true) {
                var yok = new Discord.MessageEmbed()
                    .setAuthor(`${client.ayarlar.botİsim} Bot`, message.author.avatarURL({dynamic:true}))
                    .setColor(client.ayarlar.embedRenk)
                    .setDescription(`<:neutralno:910935142707646484> Sayın ${message.author}, Üzgünüm ancak yedek temizle adlı komutu gösteremicem! Sebep: \`Hiç Bir Yedek Kodun Yok!\``)
                    .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({dynamic:true}))
                    return message.channel.send(yok);
            }  
             ...
             .setAuthor(`${client.ayarlar.botİsim} Bot`, message.author.avatarURL({dynamic:true}))
             .setColor(client.ayarlar.embedRenk)
             .setDescription(`<:neutralno:910935142707646484> Selam ${message.author}, Eğer Yedek Kodlarınızı sıfırlamak istiyorsanız :white_check_mark: Emojisine tıklayın! (İptal Etmek İçin :x: Emojisine Tıklayın!)`)
             .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({dynamic:true}))
             return message.channel.send(embed).then(msg => {
                ...
                yes.on("collect", r => {
                   ...
                   .setAuthor(`${client.ayarlar.botİsim} Bot`, message.author.avatarURL({dynamic:true}))
                   .setColor(client.ayarlar.embedRenk)
                   .setDescription(`<:neutralyes:910935020120735806> Selam ${message.author}, Başarılı bir şekilde tüm yedek kodlarınız silindi!`)
                   .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({dynamic:true}))
        ...
        if(args[0] === "sil" || args[0] === "remove") {
            ...
            if(!db.has(`yedek_${message.author.id}`) === true) {
                var yok = new Discord.MessageEmbed()
                    .setAuthor(`${client.ayarlar.botİsim} Bot`, message.author.avatarURL({dynamic:true}))
                    .setColor(client.ayarlar.embedRenk)
                    .setDescription(`<:neutralno:910935142707646484> Sayın ${message.author}, Üzgünüm ancak yedek sil adlı komutu gösteremicem! Sebep: \`Hiç Bir Yedek Kodun Yok!\``)
                    .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({dynamic:true}))
                    return message.channel.send(yok);
            }  
            ...
            if(data.length === 1) {
             ...
             var yok = new Discord.MessageEmbed()
                    .setAuthor(`${client.ayarlar.botİsim} Bot`, message.author.avatarURL({dynamic:true}))
                    .setColor(client.ayarlar.embedRenk)
                    .setDescription(`<:neutralyes:910935020120735806> Başarılı bir şekilde **${id}** İD'li yedek kodunu sildim!`)
                    .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({dynamic:true}))
                    return message.channel.send(yok);
            } else {
        ...
        if (args[0] === "yükle") {
            let data = db.get(`yedek_${message.author.id}`)
             ...
             if(!id) {
                ...
                .setAuthor(`${client.ayarlar.botİsim} Bot`, message.author.avatarURL({dynamic:true}))
                .setColor(client.ayarlar.embedRenk)
                .setDescription(`<:neutralno:910935142707646484> Dostum, eğer bir yedek yüklemek istiyorsan o yedek kodunun id'sini belirtmelisin.`)
                .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({dynamic:true}))
                return message.channel.send(yok);
             }
             ...
             if(data.includes((s) => s.yedekid !== id)) {
                ...
                .setAuthor(`${client.ayarlar.botİsim} Bot`, message.author.avatarURL({dynamic:true}))
                .setColor(client.ayarlar.embedRenk)
                .setDescription(`<:neutralno:910935142707646484> Dostum, Yedek kodlarına baktım ve **${id}** İD'li bir kod bulamadım.`)
                .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({dynamic:true}))
                return message.channel.send(yok);
             }
		  ...
		  if(args[0] === "bilgi") {
			  ...
			  if(!db.has(`yedek_${message.author.id}`) === true) {
                var yok = new Discord.MessageEmbed()
                    .setAuthor(`${client.ayarlar.botİsim} Bot`, message.author.avatarURL({dynamic:true}))
                    .setColor(client.ayarlar.embedRenk)
                    .setDescription(`<:neutralno:910935142707646484> Sayın ${message.author}, Üzgünüm ancak yedek bilgi adlı komutu gösteremicem! Sebep: \`Hiç Bir Yedek Kodun Yok!\``)
                    .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({dynamic:true}))
                    return message.channel.send(yok);
            }
        ...
        .setAuthor(`${client.ayarlar.botİsim} Bot`, message.author.avatarURL({ dynamic: true }))
        .setColor(client.ayarlar.embedRenk)
        .setDescription(`<:wunlem:911958090298032228> Wonders Dünyasında dolaşırken bir hata ile karşılaştım! lütfen bu hatayı sahibime bildir!\nHata: \`${error}\`\nDestek Sunucum: https://discord.gg/CTsvk5XuUk`)
        .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({ dynamic: true }))
