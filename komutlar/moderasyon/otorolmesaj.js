    ...
    dbl.hasVoted(message.author.id).then(voted => {
        ...
        if(voted === true) {
            if(!args[0]) {
               ...
               .setColor("GOLD")
               .setDescription(`<:neutralno:910935142707646484> Merhaba, Öncelikle otorol mesajı ayarlamak istiyorsan eğer bir değer belirtmelisin! örnek: ${prefix}otorolmesaj ayarla veya ${prefix}otorolmesaj sıfırla!`)
             ...
             if(args[0] === "ayarla") {
                   if(!mesaj) {
                      const embedd = new Discord.MessageEmbed()
                      .setColor("GOLD")
                      .setDescription(`<:neutralno:910935142707646484> Merhaba, Öncelikle otorol mesajı ayarlamak istiyorsan eğer bir mesaj belirtmelisin! örnek: ${prefix}otorolmesaj ayarla <mesaj>`)
                   ...
                   const embedd = new Discord.MessageEmbed()
                  .setColor("GOLD")
                  .setDescription(`<:neutralyes:910935020120735806> Merhaba, Başarılı bir şekilde otorol mesajını ayarladım!\n Ayarlanmış değer: **${mesaj}**`)
                  .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({ dynamic: true }))
                  return message.channel.send(embedd)
             }
             ...
             if(args[0] === "sıfırla") {
                 ...
                 const embedd = new Discord.MessageEmbed()
               .setColor("GOLD")
               .setDescription(`<:neutralyes:910935020120735806> Merhaba, Başarılı bir şekilde otorol mesajı sıfırlandı!`)
               .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({ dynamic: true }))
               return message.channel.send(embedd)
             }
        } else {
