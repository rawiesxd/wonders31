...
exports.run = async (client, message, args, prefix) => {
  ...
  const dbl = new DBL(`eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6Ijc0NDUwNjQ5NjI1NTAwMDU5NiIsImJvdCI6dHJ1ZSwiaWF0IjoxNjA2MDQxMjA3fQ.vUs8drqgyaCvQOuih0CE11sqsa1n2ZwYiR_lkq8e4mo`,client)
    ...
    if(!args[0]) {
      ...
      .setColor("GOLD")
      .setDescription(`<:neutralno:910935142707646484> Merhaba, Öncelikle sayaç mesajı ayarlamak istiyorsan eğer bir değer belirtmelisin! örnek: ${prefix}sayaçbbmesaj ayarla veya ${prefix}sayaçbbmesaj sıfırla!`)
    ...
    const embedd = new Discord.MessageEmbed()
      .setColor("GOLD")
      .setDescription(`<:neutralyes:910935020120735806> Merhaba, Başarılı bir şekilde sayaç görüşürüz mesajını ayarladım!\n Ayarlanmış değerler; Mesaj: ${mesaj}`)
      .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({ dynamic: true }))
      return message.channel.send(embedd)	
    }
