...
*/
    ...
    .setColor(client.ayarlar.embedRenk)
    .setDescription(`
    <:neutralyes:910935020120735806> Bir kişi **Kız** olarak kayıt edildi!
    `)
    ...
    .setColor(client.ayarlar.embedRenk)
    .setDescription(`
    <:neutralyes:910935020120735806> Başarılı bir şekilde belirttiğiniz kişi **Kız** olarak kayıt edildi!
    `)
    .addField("Kişi Bilgileri:", `
    • | Adı: **${tag} | ${isim}**
    • | ID: **${kişi.id}**
