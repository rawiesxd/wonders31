...
exports.run = async(client, message, args, prefix) => {
    ...
    if(!tag) {
        ...
        .setDescription(`
        <:neutralno:910935142707646484> Kayıt tagı ayarlanmamış!
    ...
    if(!alınacakrol) {
        ...
        .setColor(client.ayarlar.embedRenk)
        .setDescription(`
        <:neutralno:910935142707646484> Kayıt alınacak rolü ayarlanmamış!
    ...
    if(!erkekrol) {
        ...
        .setColor(client.ayarlar.embedRenk)
        .setDescription(`
        <:neutralno:910935142707646484> Kayıt erkek rolü ayarlanmamış!
    ...
    if(!yetkili) {
        ...
        .setColor(client.ayarlar.embedRenk)
        .setDescription(`
        <:neutralno:910935142707646484> Kayıt yetkili rolü ayarlanmamış!
    ...
    if(!kayıtkanal) {
        ...
        .setColor(client.ayarlar.embedRenk)
        .setDescription(`
        <:neutralno:910935142707646484> Kayıt kanalı ayarlanmamış!
    ...
    if(!message.member.roles.cache.has(db.fetch(`kayıtyetkilirol_${message.guild.id}`))) {
        ...
        .setColor(client.ayarlar.embedRenk)
        .setDescription(`
        <:neutralno:910935142707646484> Kayıt yetkili rolüne sahip değilsin!
        `)
        .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({ dynamic: true }))
        return message.channel.send(embed)
    }
    ...
    if(message.channel.id !== db.fetch(`kayıtkanal_${message.guild.id}`)) {
        ...
        .setColor(client.ayarlar.embedRenk)
        .setDescription(`
        <:neutralno:910935142707646484> Bu kanal kayıt kanalı değil! (<#${db.fetch(`kayıtkanal_${message.guild.id}`)}> Kanalında kullanın.)
        `)
        .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({ dynamic: true }))
        return message.channel.send(embed)
    }
    ...
    if(!kişi) {
        ...
        .setColor(client.ayarlar.embedRenk)
        .setDescription(`
        <:neutralno:910935142707646484> Lütfen bir kişi etiketle!
        `)
        .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({ dynamic: true }))
        return message.channel.send(embed)
    }
    ...
    if(!isim) {
        ...
        .setColor(client.ayarlar.embedRenk)
        .setDescription(`
        <:neutralno:910935142707646484> Lütfen bir isim belirt!
        `)
        .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({ dynamic: true }))
        return message.channel.send(embed)
    }
...
*/
    if(isim.startsWith(tag) || isim.includes(tag)) {
        ...
        .setColor(client.ayarlar.embedRenk)
        .setDescription(`
        <:neutralno:910935142707646484> Belirttiğiniz isim içerisinde **${tag}** Bulunmamalıdır! (kayıt edilince otomatik en başa koyacaktır tagı!)
        `)
        .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({ dynamic: true }))
        return message.channel.send(embed)
    }
    ...
    .setColor(client.ayarlar.embedRenk)
    .setDescription(`
    <:neutralyes:910935020120735806> Bir kişi **Erkek** olarak kayıt edildi!
    `)
    ...
    .setColor(client.ayarlar.embedRenk)
    .setDescription(`
    <:neutralyes:910935020120735806> Başarılı bir şekilde belirttiğiniz kişi **Erkek** olarak kayıt edildi!
    `)
    .addField("Kişi Bilgileri:", `
    • | Adı: **${tag} | ${isim}**
    • | ID: **${kişi.id}**
