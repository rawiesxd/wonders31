    ...
    if(voted === true) {
        let timeout = 86400000;
            ...
            if(db.fetch(`çalışSüre_${message.author.id}`) > Date.now()) {
               ...
               `)
                .setFooter("Copyright © Wonders Bot 2022", client.user.avatarURL())
               .setTimestamp()
            ...
            .setDescription(`
            <:neutralyes:910935020120735806> **${nbr[meslek]}** Olarak çalıştınız ve **${sa}** Miktarında kredinizi aldınız.
            `)
