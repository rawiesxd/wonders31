...
exports.run = async(client, message, args, prefix) => {
    if(!args[0]) {
        ...
        .setDescription(`
        <:neutralno:910935142707646484> Lütfen bir değer belirt!
    ...
    if(args[0] === "yatır") {
        ...
        if(!miktar) {
            ...
            .setColor(client.ayarlar.embedRenk)
            .setDescription(`
            <:neutralno:910935142707646484> Lütfen yatırılacak miktarı belirtin.
            `)
            .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({ dynamic: true }))
            return message.channel.send(market) 
        }
        ...
        if(!db.fetch(`goldkredi_${message.author.id}`)) {
            ...
            .setColor(client.ayarlar.embedRenk)
            .setDescription(`
            <:neutralno:910935142707646484> Hesabınızda kredi yok.
            `)
            .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({ dynamic: true }))
            return message.channel.send(market) 
        }
        ...
        if(linkler < miktar) {
            ...
            .setColor(client.ayarlar.embedRenk)
            .setDescription(`
            <:neutralno:910935142707646484> **${miktar}** Adet krediniz yok!
            `)
            .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({ dynamic: true }))
            return message.channel.send(market) 
        }
        ...
        .setColor(client.ayarlar.embedRenk)
        .setDescription(`
        <:neutralyes:910935020120735806> Başarılı bir şekilde **${miktar}** Miktarında kredinizi bankaya yatırdım!
        `)
        .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({ dynamic: true }))
        return message.channel.send(market) 
    }
    ...
    if(args[0] === "çek") {
        ...
        if(!miktar) {
            ...
            .setColor(client.ayarlar.embedRenk)
            .setDescription(`
            <:neutralno:910935142707646484> Lütfen çekilecek miktarı belirtin.
            `)
            .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({ dynamic: true }))
            return message.channel.send(market) 
        }
        ...
        if(!db.fetch(`banka_${message.author.id}`)) {
            ...
            .setColor(client.ayarlar.embedRenk)
            .setDescription(`
            <:neutralno:910935142707646484> Bankanızda kredi yok!
            `)
            .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({ dynamic: true }))
            return message.channel.send(market) 
        }
        ...
        if(db.fetch(`banka_${message.author.id}`) < miktar) {
            ...
            .setColor(client.ayarlar.embedRenk)
            .setDescription(`
            <:neutralno:910935142707646484> Bankanızda **${miktar}** Miktarında kredi yok!
            `)
            .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({ dynamic: true }))
            return message.channel.send(market) 
        }
        ...
        .setColor(client.ayarlar.embedRenk)
        .setDescription(`
        <:neutralyes:910935020120735806> Başarılı bir şekilde **${miktar}** Miktarında kredinizi bankadan çektim!
        `)
        .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({ dynamic: true }))
        return message.channel.send(market) 
    ...
    if(args[0] === "transfer") {
        ...
        if(!kişi) {
            ...
            .setColor(client.ayarlar.embedRenk)
            .setDescription(`
            <:neutralno:910935142707646484> Lütfen bir kişi etiketleyin.
            `)
            .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({ dynamic: true }))
            return message.channel.send(market) 
        }
        ...
        if(!miktar) {
            ...
            .setColor(client.ayarlar.embedRenk)
            .setDescription(`
            <:neutralno:910935142707646484> Lütfen gönderilecek miktarı belirtin.
            `)
            .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({ dynamic: true }))
            return message.channel.send(market) 
        }
        ...
        .setColor(client.ayarlar.embedRenk)
        .setDescription(`
        <:neutralyes:910935020120735806> Başarılı bir şekilde **${miktar}** Miktarında kredinizi ${kişi} Adlı kişiye transfer ettim!
        `)
        .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({ dynamic: true }))
        return message.channel.send(market) 
    ...
    if(args[0] === "bilgi") {
        ...
        if(kişi.id === client.user.id) {
            ...
            .setColor(client.ayarlar.embedRenk)
            .setDescription(`
            <:neutralno:910935142707646484> Benim banka bilgilerime bakamazsın!
            `)
            .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({ dynamic: true }))
            return message.channel.send(market) 
        }
       ...
       return {
        ...
        market.addField("Wonders Kartı Bilgileri:", `
        ${list2.splice(0, 5).map((item, index) => `**${index + 1} - ** ${item.id} => [Zaman: **${item.zaman}** - Para: **${item.para}**]`).join("\n")}
        `)
        } else {
        market.addField("Wonders Kartı Bilgileri:", `
        • | <:neutralno:910935142707646484> **Herhangi bir kredi kartı yok.**
        `)
        }
        ...
        • | **${kredi}**
        `)
		.addField("Wonders Kartı Bilgileri:", `
		• | **Yok**
		`)
		.addField("İşlemler:", `<:neutralno:910935142707646484> **Herhangi bir işlem yok.**`)
        return message.channel.send(market) 
		}
