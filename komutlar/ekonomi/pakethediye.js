...
exports.run = (client, message, args, prefix) => {
    ...
    if(args[0] === "paket1") {
        ...
        if(kişi.bot) {
            ...
            .setDescription(`
            Selam ${message.author},
            <:neutralno:910935142707646484> Bir Bota Paket Hediye Edemezsiniz!
            `)
            .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({ dynamic: true }))
            return message.channel.send(market)
        }
        ...
        if(kişi.id === message.author.id) {
            ...
            .setDescription(`
            Selam ${message.author},
            <:neutralno:910935142707646484> Kendine Paket Hediye Edemezsin!
            `)
            .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({ dynamic: true }))
            return message.channel.send(market)
        }
        ...
        function getRandomInt(min, max) {
            ...
            return Math.floor(Math.random() * (max - min)) + min;
                ...
                if(db.fetch(`goldsüre_${kişi.id}`) > 2592000000) {
                    ...
                    return message.channel.send(`<a:goldkrsm:857214678975250472> Gold Üyelik Süreniz **30 Gün**'e Ulaştı ve ya **30 Gün**'ün Üstüne ulaştı daha fazla satın alamazsınız.`)
                }
                ...
                if(gold) {
                    ...
                    .setColor(client.ayarlar.embedRenk)
                    .setDescription(`
                    <a:goldkrsm:857214678975250472> ${kişi} (${kişi.id}) Adlı kullanıcı **${sure} Gün** Boyunca **Gold Üyelik** Kazandı!
                    `)
                    .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({ dynamic: true }))
                    kanal.send(kazandı)
                    ...
                    .setColor(client.ayarlar.embedRenk)
                    .setDescription(`
                    <a:goldkrsm:857214678975250472> Başarılı Bir Şekilde ${kişi} Adlı Kişiye **${sure} Gün** Boyunca **Gold Üyelik** Hediye Ettiniz!
                    `)
                    .setFooter(client.ayarlar.embedFooter, message.author.avatarURL({ dynamic: true }))
                    return message.channel.send(market)
                } else {
